...
1. [Use the u Tag to Underline Text](https://www.freecodecamp.org/learn/responsive-web-design/applied-visual-design/use-the-u-tag-to-underline-text)
    ...
    ```
1. [Use the em Tag to Italicize Text](https://www.freecodecamp.org/learn/responsive-web-design/applied-visual-design/use-the-em-tag-to-italicize-text)
    ```html
    <style>
    h4 {
        text-align: center;
    ...
    ```
1. [Use the s Tag to Strikethrough Text](https://www.freecodecamp.org/learn/responsive-web-design/applied-visual-design/use-the-s-tag-to-strikethrough-text)
    ```html
    <style>
    h4 {
        text-align: center;
    ...
    ```
1. [Create a Horizontal Line Using the hr Element](https://www.freecodecamp.org/learn/responsive-web-design/applied-visual-design/create-a-horizontal-line-using-the-hr-element)
    ```html
    <style>
    h4 {
        text-align: center;
    ...
    ```
1. [Adjust the background-color Property of Text](https://www.freecodecamp.org/learn/responsive-web-design/applied-visual-design/adjust-the-background-color-property-of-text)
    ```html
    <style>
    h4 {
        text-align: center;
    ...
    ```
1. [Adjust the Size of a Header Versus a Paragraph Tag](https://www.freecodecamp.org/learn/responsive-web-design/applied-visual-design/adjust-the-size-of-a-header-versus-a-paragraph-tag)
    ```html
    <style>
        h4 {
        text-align: center;
...
1. [Access Multi-Dimensional Arrays With Indexes](https://learn.freecodecamp.org/javascript-algorithms-and-data-structures/basic-javascript/access-multi-dimensional-arrays-with-indexes/)
    ...
    ```
1. [Manipulate Arrays With push()](https://learn.freecodecamp.org/javascript-algorithms-and-data-structures/basic-javascript/manipulate-arrays-with-push/)
    ```javascript
    // Example
...
1. [Comparison with the Inequality Operator](https://learn.freecodecamp.org/javascript-algorithms-and-data-structures/basic-javascript/comparison-with-the-inequality-operator/)
    ...
    testNotEqual(10);
    ```
1. [Comparison with the Strict Inequality Operator](https://learn.freecodecamp.org/javascript-algorithms-and-data-structures/basic-javascript/comparison-with-the-strict-inequality-operator/)
    ```javascript
    // Setup
    ...
    ```
1. [Comparison with the Greater Than Operator](https://learn.freecodecamp.org/javascript-algorithms-and-data-structures/basic-javascript/comparison-with-the-greater-than-operator/)
    ```javascript
    ...
    testGreaterThan(10);
    ```
1. [Comparison with the Greater Than Or Equal To Operator](https://learn.freecodecamp.org/javascript-algorithms-and-data-structures/basic-javascript/comparison-with-the-greater-than-or-equal-to-operator/)
    ```javascript
    ...
    ```
1. [Comparison with the Less Than Operator](https://learn.freecodecamp.org/javascript-algorithms-and-data-structures/basic-javascript/comparison-with-the-less-than-operator/)
    ```javascript
    ...
    testLessThan(10);
    ```
1. [Comparison with the Less Than Or Equal To Operator](https://learn.freecodecamp.org/javascript-algorithms-and-data-structures/basic-javascript/comparison-with-the-less-than-or-equal-to-operator/)
    ```javascript
...
1. [Multiple Identical Options in Switch Statements](https://learn.freecodecamp.org/javascript-algorithms-and-data-structures/basic-javascript/multiple-identical-options-in-switch-statements/)
    ...
    sequentialSizes(1);
    ```
1. [Replacing If Else Chains with Switch](https://learn.freecodecamp.org/javascript-algorithms-and-data-structures/basic-javascript/replacing-if-else-chains-with-switch/)
    ```javascript
    ...
    chainToSwitch(7);
    ```
1. [Returning Boolean Values from Functions](https://learn.freecodecamp.org/javascript-algorithms-and-data-structures/basic-javascript/returning-boolean-values-from-functions/)
    ```javascript
    function isLess(a, b) {
        // Fix this code
        return a < b;
    ...
    isLess(10, 15);
    ```
1. [Return Early Pattern for Functions](https://learn.freecodecamp.org/javascript-algorithms-and-data-structures/basic-javascript/return-early-pattern-for-functions/)
    ```javascript
    // Setup
    function abTest(a, b) {
        // Only change code below this line
...
1. [Counting Cards](https://learn.freecodecamp.org/javascript-algorithms-and-data-structures/basic-javascript/counting-cards/)
    ...
    ```
1. [Build JavaScript Objects](https://learn.freecodecamp.org/javascript-algorithms-and-data-structures/basic-javascript/build-javascript-objects/)
    ```javascript
    // Example
    var ourDog = {
        "name": "Camper",
...
1. [Create Strings using Template Literals](https://www.freecodecamp.org/learn/javascript-algorithms-and-data-structures/es6/create-strings-using-template-literals)
    ...
    function makeList(arr) {
        ...
        const resultDisplayArray = arr.map(
            (msg) => `<li class="text-warning">${msg}</li>`
        );
        // change code above this line
...
1. [Catch Off By One Errors When Using Indexing](https://www.freecodecamp.org/learn/javascript-algorithms-and-data-structures/debugging/catch-off-by-one-errors-when-using-indexing)
    ...
    countToFive();
    ```
1. [Use Caution When Reinitializing Variables Inside a Loop](https://www.freecodecamp.org/learn/javascript-algorithms-and-data-structures/debugging/use-caution-when-reinitializing-variables-inside-a-loop)
    ```javascript
...
1. [Create a Method on an Object](https://learn.freecodecamp.org/javascript-algorithms-and-data-structures/object-oriented-programming/create-a-method-on-an-object)
    ...
    dog.sayLegs();
    ```
1. [Make Code More Reusable with the this Keyword](https://learn.freecodecamp.org/javascript-algorithms-and-data-structures/object-oriented-programming/make-code-more-reusable-with-the-this-keyword)
    ```javascript
    let dog = {
        name: "Spot",
        numLegs: 4,
    ...
    dog.sayLegs();
    ```
1. [Define a Constructor Function](https://learn.freecodecamp.org/javascript-algorithms-and-data-structures/object-oriented-programming/define-a-constructor-function)
    ```javascript
    function Dog() {
        this.name = "Fofa";
        this.color = "Brown";
    ...
    ```
1. [Use a Constructor to Create Objects](https://learn.freecodecamp.org/javascript-algorithms-and-data-structures/object-oriented-programming/use-a-constructor-to-create-objects)
    ```javascript
    function Dog() {
        this.name = "Rupert";
        this.color = "brown";
    ...
    let hound = new Dog();
    ```
1. [Extend Constructors to Receive Arguments](https://learn.freecodecamp.org/javascript-algorithms-and-data-structures/object-oriented-programming/extend-constructors-to-receive-arguments)
    ```javascript
    ...
    let terrier = new Dog("Ig", "white");
    ```
1. [Verify an Object's Constructor with instanceof](https://learn.freecodecamp.org/javascript-algorithms-and-data-structures/object-oriented-programming/verify-an-objects-constructor-with-instanceof)
    ```javascript
    /* jshint expr: true */
    ...
    ```
1. [Understand Own Properties](https://learn.freecodecamp.org/javascript-algorithms-and-data-structures/object-oriented-programming/understand-own-properties/)
    ```javascript
    function Bird(name) {
        this.name = name;
        this.numLegs = 2;
    ...
    ```
1. [Use Prototype Properties to Reduce Duplicate Code](https://learn.freecodecamp.org/javascript-algorithms-and-data-structures/object-oriented-programming/use-prototype-properties-to-reduce-duplicate-code)
    ```javascript
    function Dog(name) {
        this.name = name;
    }
    ...
    ```
1. [Iterate Over All Properties](https://learn.freecodecamp.org/javascript-algorithms-and-data-structures/object-oriented-programming/iterate-over-all-properties)
    ```javascript
    function Dog(name) {
        this.name = name;
    }
    ...
    ```
1. [Understand the Constructor Property](https://learn.freecodecamp.org/javascript-algorithms-and-data-structures/object-oriented-programming/understand-the-constructor-property)
    ```javascript
    function Dog(name) {
        this.name = name;
    }
    ...
    ```
1. [Change the Prototype to a New Object](https://learn.freecodecamp.org/javascript-algorithms-and-data-structures/object-oriented-programming/change-the-prototype-to-a-new-object)
    ```javascript
    function Dog(name) {
        this.name = name;
    }
    ...
    ```
1. [Remember to Set the Constructor Property when Changing the Prototype](https://learn.freecodecamp.org/javascript-algorithms-and-data-structures/object-oriented-programming/remember-to-set-the-constructor-property-when-changing-the-prototype)
    ```javascript
    function Dog(name) {
        this.name = name;
    }
    ...
    ```
1. [Understand Where an Object’s Prototype Comes From](https://learn.freecodecamp.org/javascript-algorithms-and-data-structures/object-oriented-programming/understand-where-an-objects-prototype-comes-from)
    ```javascript
    function Dog(name) {
        this.name = name;
    }
    ...
    ```
1. [Understand the Prototype Chain](https://learn.freecodecamp.org/javascript-algorithms-and-data-structures/object-oriented-programming/understand-the-prototype-chain/)
    ```javascript
    function Dog(name) {
        this.name = name;
    }
    ...
    ```
1. [Use Inheritance So You Don't Repeat Yourself](https://learn.freecodecamp.org/javascript-algorithms-and-data-structures/object-oriented-programming/use-inheritance-so-you-dont-repeat-yourself/)
    ```javascript
    function Cat(name) {
        this.name = name;
    }
    ...
    ```
1. [Inherit Behaviors from a Supertype](https://learn.freecodecamp.org/javascript-algorithms-and-data-structures/object-oriented-programming/inherit-behaviors-from-a-supertype/)
    ```javascript
    function Animal() { }
    ...
    ```
1. [Set the Child's Prototype to an Instance of the Parent](https://learn.freecodecamp.org/javascript-algorithms-and-data-structures/object-oriented-programming/set-the-childs-prototype-to-an-instance-of-the-parent/)
    ```javascript
    function Animal() { }
    ...
    beagle.eat();  // Should print "nom nom nom"
    ```
1. [Reset an Inherited Constructor Property](https://learn.freecodecamp.org/javascript-algorithms-and-data-structures/object-oriented-programming/reset-an-inherited-constructor-property/)
    ```javascript
    function Animal() { }
    function Bird() { }
    function Dog() { }
    ...
    let beagle = new Dog();
    ```
1. [Add Methods After Inheritance](https://learn.freecodecamp.org/javascript-algorithms-and-data-structures/object-oriented-programming/add-methods-after-inheritance/)
    ```javascript
    function Animal() { }
    ...
    ```
1. [Override Inherited Methods](https://learn.freecodecamp.org/javascript-algorithms-and-data-structures/object-oriented-programming/override-inherited-methods/)
    ```javascript
    function Bird() { }
    ...
    ```
1. [Use a Mixin to Add Common Behavior Between Unrelated Objects](https://learn.freecodecamp.org/javascript-algorithms-and-data-structures/object-oriented-programming/use-a-mixin-to-add-common-behavior-between-unrelated-objects/)
    ```javascript
    let bird = {
        name: "Donald",
        numLegs: 2
    ...
    boat.glide();
    ```
1. [Use Closure to Protect Properties Within an Object from Being Modified Externally](https://learn.freecodecamp.org/javascript-algorithms-and-data-structures/object-oriented-programming/use-closure-to-protect-properties-within-an-object-from-being-modified-externally/)
    ```javascript
    function Bird() {
        let weight = 15;
...
1. [Understand the Immediately Invoked Function Expression (IIFE)]()
    ...
    ```
1. [Use an IIFE to Create a Module](https://learn.freecodecamp.org/javascript-algorithms-and-data-structures/object-oriented-programming/use-an-iife-to-create-a-module/)
    ```javascript
    let funModule = (
        function () {
            return {
...
1. [Learn About Functional Programming](https://learn.freecodecamp.org/javascript-algorithms-and-data-structures/functional-programming/learn-about-functional-programming/)
    ```javascript
    /**
    ...
    **/
    ...
    ```
1. [Understand Functional Programming Terminology](https://learn.freecodecamp.org/javascript-algorithms-and-data-structures/functional-programming/understand-functional-programming-terminology/)
    ```javascript
    /**
    ...
    **/
    ...
    ```
1. [Understand the Hazards of Using Imperative Code](https://learn.freecodecamp.org/javascript-algorithms-and-data-structures/functional-programming/understand-the-hazards-of-using-imperative-code/)
    ```javascript
    ...
    ```
1. [Avoid Mutations and Side Effects Using Functional Programming](https://learn.freecodecamp.org/javascript-algorithms-and-data-structures/functional-programming/avoid-mutations-and-side-effects-using-functional-programming/)
    ```javascript
    // the global variable
    var fixedValue = 4;
    ...
    ```
1. [Pass Arguments to Avoid External Dependence in a Function](https://learn.freecodecamp.org/javascript-algorithms-and-data-structures/functional-programming/pass-arguments-to-avoid-external-dependence-in-a-function/)
    ```javascript
    // the global variable
    var fixedValue = 4;
    ...
    console.log(fixedValue); // Should print 4
    ```
1. [Refactor Global Variables Out of Functions](https://learn.freecodecamp.org/javascript-algorithms-and-data-structures/functional-programming/refactor-global-variables-out-of-functions/)
    ```javascript
    // the global variable
    ...
    ```
1. [Use the map Method to Extract Data from an Array](https://learn.freecodecamp.org/javascript-algorithms-and-data-structures/functional-programming/use-the-map-method-to-extract-data-from-an-array/)
    ```javascript
    // the global variable
    var watchList = [
        {
    ...
    console.log(rating);
    ```
1. [Implement map on a Prototype](https://learn.freecodecamp.org/javascript-algorithms-and-data-structures/functional-programming/implement-map-on-a-prototype/)
    ```javascript
    // the global Array
    var s = [23, 65, 98, 5];
    ...
    console.log(new_s);
    ```
1. [Use the filter Method to Extract Data from an Array](https://learn.freecodecamp.org/javascript-algorithms-and-data-structures/functional-programming/use-the-filter-method-to-extract-data-from-an-array/)
    ```javascript
    // the global variable
    var watchList = [
        {
    ...
    var filteredList = watchList
        ...
        .filter(
            (ele) => {
                return parseFloat(ele.rating) > 8
            }
        );
    ...
    ```
1. [Implement the filter Method on a Prototype](https://learn.freecodecamp.org/javascript-algorithms-and-data-structures/functional-programming/implement-the-filter-method-on-a-prototype/)
    ```javascript
    // the global Array
    var s = [23, 65, 98, 5];
    ...
    console.log(new_s);
    ```
1. [Return Part of an Array Using the slice Method](https://learn.freecodecamp.org/javascript-algorithms-and-data-structures/functional-programming/return-part-of-an-array-using-the-slice-method)
    ```javascript
    ...
    ```
1. [Remove Elements from an Array Using slice Instead of splice](https://learn.freecodecamp.org/javascript-algorithms-and-data-structures/functional-programming/remove-elements-from-an-array-using-slice-instead-of-splice/)
    ```javascript
    ...
    ```
1. [Combine Two Arrays Using the concat Method](https://learn.freecodecamp.org/javascript-algorithms-and-data-structures/functional-programming/combine-two-arrays-using-the-concat-method/)
    ```javascript
    ...
    ```
1. [Add Elements to the End of an Array Using concat Instead of push](https://learn.freecodecamp.org/javascript-algorithms-and-data-structures/functional-programming/add-elements-to-the-end-of-an-array-using-concat-instead-of-push/)
    ```javascript
    ...
    ```
1. [Use the reduce Method to Analyze Data](https://learn.freecodecamp.org/javascript-algorithms-and-data-structures/functional-programming/use-the-reduce-method-to-analyze-data/)
    ```javascript
    // the global variable
    var watchList = [
        {
    ...
    var NolanMovies = watchList
        .filter(
            (ele) => ele.Director === "Christopher Nolan"
        );
    var averageRating = NolanMovies
        .map(
            (ele) => Number(ele.imdbRating)
        )
        .reduce(
            (acc, ele) => acc + ele
        );

    averageRating = averageRating / NolanMovies.length;
...
1. [Sort an Array Alphabetically using the sort Method](https://learn.freecodecamp.org/javascript-algorithms-and-data-structures/functional-programming/sort-an-array-alphabetically-using-the-sort-method/)
    ...
    ```
1. [Return a Sorted Array Without Changing the Original Array](https://learn.freecodecamp.org/javascript-algorithms-and-data-structures/functional-programming/return-a-sorted-array-without-changing-the-original-array/)
    ```javascript
    ...
    ```
1. [Split a String into an Array Using the split Method](https://learn.freecodecamp.org/javascript-algorithms-and-data-structures/functional-programming/split-a-string-into-an-array-using-the-split-method/)
    ```javascript
    ...
    ```
1. [Combine an Array into a String Using the join Method](https://learn.freecodecamp.org/javascript-algorithms-and-data-structures/functional-programming/combine-an-array-into-a-string-using-the-join-method/)
    ```javascript
    ...
    ```
1. [Apply Functional Programming to Convert Strings to URL Slugs](https://learn.freecodecamp.org/javascript-algorithms-and-data-structures/functional-programming/apply-functional-programming-to-convert-strings-to-url-slugs/)
    ```javascript
    // the global variable
...
1. [Search and Replace](https://learn.freecodecamp.org/javascript-algorithms-and-data-structures/intermediate-algorithm-scripting/search-and-replace/)
    ...
    ```
1. [DNA Pairing](https://learn.freecodecamp.org/javascript-algorithms-and-data-structures/intermediate-algorithm-scripting/dna-pairing/)
    ```javascript
...
1. [Missing letters](https://learn.freecodecamp.org/javascript-algorithms-and-data-structures/intermediate-algorithm-scripting/missing-letters/)
    ...
    fearNotLetter("stvwx");
    ```
1. [Sorted Union](https://learn.freecodecamp.org/javascript-algorithms-and-data-structures/intermediate-algorithm-scripting/sorted-union/)
    ```javascript
    ...
    ```
1. [Convert HTML Entities](https://learn.freecodecamp.org/javascript-algorithms-and-data-structures/intermediate-algorithm-scripting/convert-html-entities/)
    ```javascript
...
1. [Sum All Odd Fibonacci Numbers](https://learn.freecodecamp.org/javascript-algorithms-and-data-structures/intermediate-algorithm-scripting/sum-all-odd-fibonacci-numbers/)
    ...
    sumFibs(4);
    ```
1. [Sum All Primes](https://learn.freecodecamp.org/javascript-algorithms-and-data-structures/intermediate-algorithm-scripting/sum-all-primes/)
    ```javascript
...
1. [Smallest Common Multiple](https://learn.freecodecamp.org/javascript-algorithms-and-data-structures/intermediate-algorithm-scripting/smallest-common-multiple/)
    ...
    ```
1. [Drop it](https://learn.freecodecamp.org/javascript-algorithms-and-data-structures/intermediate-algorithm-scripting/drop-it/)
    ```javascript
...
1. [Steamroller](https://learn.freecodecamp.org/javascript-algorithms-and-data-structures/intermediate-algorithm-scripting/steamroller)
    ...
    ```
1. [Binary Agents](https://learn.freecodecamp.org/javascript-algorithms-and-data-structures/intermediate-algorithm-scripting/binary-agents)
    ```javascript
    ...
    ```
1. [Everything Be True](https://learn.freecodecamp.org/javascript-algorithms-and-data-structures/intermediate-algorithm-scripting/everything-be-true)
    ```javascript
